...
class DomainRedirect
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $isNotInternalDomain = !in_array($host, ['carlov.local', 'carlov.local.internal', '192.168.8.110', '192.168.1.100', 'carlov-ristorante', 'carlov-ristorante.tailecb1d9.ts.net', 'carlov.appbeet.com']); ;
