! function ()
{
    ...
    function s(s, n)
    {
        ...
        T.attr("type", "text"), n.darktheme && l.addClass("darktheme"),
            c('<button type="button" class="waves-effect waves-gray btn-flat clockpicker-button" tabindex="' + (n.twelvehour ? "3" : "1") + '">' + n.nowtext + "</button>").click(c.proxy(this.now, this)).appendTo(this.footer),
            c('<button type="button" class="waves-effect waves-red btn-flat clockpicker-button" tabindex="' + (n.twelvehour ? "3" : "1") + '">' + n.cleartext + "</button>").click(c.proxy(this.clear, this)).appendTo(this.footer),
            c('<button type="button" class="waves-effect waves-green btn-flat clockpicker-button" tabindex="' + (n.twelvehour ? "3" : "1") + '">' + n.donetext + "</button>").click(c.proxy(this.done, this)).appendTo(this.footer),
            this.spanHours.click(c.proxy(this.toggleView, this, "hours")), this.spanMinutes.click(c.proxy(this.toggleView, this, "minutes")), T.on("focus.clockpicker click.clockpicker", c.proxy(this.show, this));
    ...
    }, s.prototype.now = function ()
    {
        ...
        this.hours = +s[0] || 0, this.minutes = +s[1] || 0, this.spanHours.html(i(this.hours)), this.spanMinutes.html(i(this.minutes)), this.toggleView("hours"), this.locate()
