@extends('backoffice.layout', ['title' => 'Tavoli occupati',])
@section('breadcrumb')
    @include('backoffice.components.breadcrumb', [
        'level_1' => ['label' => 'Tavoli occupati'],
    ])
@endsection
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mt-3">
                            <div class="alert alert-info">
                                ...
                                <strong>Info:</strong> Questa sezione mostra tutti i tavoli ancora aperti
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="table-responsive table-responsive-amazon amazon-table">
                                <table class="table table-striped table-bordered table-hover datatable_table">
                                    ...
                                    <tr>
                                        ...
                                        <th class="all">Ultima operazione</th>
                                        <th class="all">Seduti da</th>
                                    </tr>
                                    </thead>
                                    <tfoot>
                                    <tr>
        ...
        $(document).ready(function(){
            ...
            setTimeout(() => {
                $(document).trigger('datatable', [{
                    url: '{{ route('restaurant.sales.datatable.tables') }}',
                    columns: [
