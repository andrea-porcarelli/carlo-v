...
@section('breadcrumb')
    @include('backoffice.components.breadcrumb', [
        ...
        'level_2' => ['label' => 'Modifica Fattura'],
    ])
@endsection
        ...
        <div class="col-xs-12 col-sm-9">
            <div class="panel panel-default">
                <div class="panel-body">
                    <form class="needs-validation edit-invoice" id="edit-invoice" novalidate>
                        <div class="row">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row supplier_refunds_index ">
                        @include('backoffice.components.form.select',['form' => 'edit-invoice', 'name' => 'supplier_id', 'label' => 'Fornitore * ', 'col' => 12, 'options' => Utils::map_collection($suppliers)])
                        @include('backoffice.components.form.select',['form' => 'edit-invoice', 'name' => 'brand_id', 'label' => 'Brand * ', 'class' => 'brand_id', 'col' => 12, 'options' => []])
                        <div class="col-xs-12">
                            <h3 class="m-t-lg">Carica il PDF della fattura</h3>
                            <hr>
                            <div class="col-xs-12">
                                @include('backoffice.components.form.upload', ['type' => 'file', 'name' => 'filename', 'path' => 'suppliers/invoices', 'class' => 'upload-article-image', 'col' => 12, 'value' => $object->filename])
                            </div>
                        ...
                        <div class="col-xs-12 text-center m-t-sm">
                            @include('backoffice.components.form.button', ['id' => $object->id,'field' => true, 'col' => 12, 'class' => 'btn-edit-invoice', 'label' => 'Modifica fattura'])
...
@section('custom-script')
    ...
    <script>
        $(document).ready(function () {
            ...
            setTimeout(() => {
                $(document).trigger('load_brands', [{
                    supplier_id: {{ $object->supplier_id }},
                    brand_id: {{ $object->brand_id }},
                    container: '.supplier_refunds_index',
                }])
            }, 100);
        })
    </script>
